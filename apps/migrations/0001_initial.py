# Generated by Django 5.2 on 2025-07-04 06:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_type', models.CharField(choices=[('universal', 'Hamma talabalar uchun'), ('min_gpa', 'GPA talab'), ('special_list', 'Faqat maxsus ro‘yxatdagi talabalar')], default='universal', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Direction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='apps.applicationtype')),
        ...
        migrations.AlterUniqueTogether(
            name='application',
            unique_together={('student', 'application_type')},
        ),
    ]
