    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction_type', models.CharField(choices=[('file', 'File'), ('test', 'Test'), ('gpa', 'GPA')], default='file', max_length=10)),
                ('require_file', models.BooleanField(default=True)),
                ('min_score', models.FloatField(default=0)),
                ('max_score', models.FloatField(default=10)),
                ('type', models.CharField(choices=[('file', 'File'), ('test', 'Test'), ('gpa', 'GPA')], default='file', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Faculty',
