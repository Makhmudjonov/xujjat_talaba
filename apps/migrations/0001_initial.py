# Generated by Django 5.2 on 2025-07-31 13:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hemis_data_id', models.CharField(blank=True, max_length=255, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('hemis_data_id', models.CharField(blank=True, db_index=True, max_length=255, null=True)),
                ('toifa', models.BooleanField(default=False)),
                ('student_id_number', models.CharField(db_index=True, max_length=255)),
                ('full_name', models.CharField(max_length=255)),
                ('short_name', models.CharField(max_length=255)),
                ('email', models.EmailField(blank=True, max_length=254, null=True)),
                ('phone', models.CharField(blank=True, max_length=255, null=True)),
