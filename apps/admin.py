...
class StudentAdmin(SimpleHistoryAdmin):
    ...
    autocomplete_fields = ('specialty', 'group_hemis', 'faculty', 'level', 'university')
...
class ApplicationAdmin(SimpleHistoryAdmin):
    ...
    list_filter = ('application_type','student__university', 'student__university1', 'student__faculty','student__specialty', 'student__toifa', DuplicateApplicationFilter,GroupLangFilter)
