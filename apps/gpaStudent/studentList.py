...
class AdminStudentListViewSet(mixins.ListModelMixin, viewsets.GenericViewSet):
    ...
    def get_queryset(self):
        ...
        return Student.objects.annotate(
            latest_gpa=Subquery(latest_gpa_subquery, output_field=FloatField())).order_by('-latest_gpa').select_related('faculty', 'level','full_name').prefetch_related('gpa_records')
